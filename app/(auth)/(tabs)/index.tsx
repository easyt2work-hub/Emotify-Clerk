...
import { View, Text, StyleSheet, ScrollView, ActivityIndicator, TouchableOpacity, Alert, Dimensions, Animated, Modal, TextInput } from "react-native";
                ...
                return (
                  <View style={styles.appointmentCard}>
                    ...
                    <View style={styles.appointmentRow}>
                      ...
                      <Text style={{ fontFamily: Theme.fontFamily.medium, fontSize: 14, color: colors.textSecondary, marginLeft: 10 }}>No appointments for today</Text>
                    </View>
                  </View>
                );
              }
